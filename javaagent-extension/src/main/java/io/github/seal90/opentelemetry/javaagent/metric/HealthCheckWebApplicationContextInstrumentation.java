 ...
 */
public class HealthCheckWebApplicationContextInstrumentation implements TypeInstrumentation {
  ...
  public void transform(TypeTransformer transformer) {
    transformer.applyAdviceToMethod(
        ...
        HealthCheckWebApplicationContextInstrumentation.class.getName() + "$FilterInjectingAdvice");
  }
